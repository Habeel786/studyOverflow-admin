...
class _HomeState extends State<Home> {
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        OutlineButton(
                          onPressed: (){
                            setState(() {
                              toggleImageText?ImageOrText=ShowTextField():ImageOrText=ShowImage();
  ...
  Widget ShowImage(){
    return Center(
      child: diagram==null&&(widget.udiagram==null||widget.udiagram=='')?Text('you havent selected Diagram'):UploadImage().enableUpload(diagram,widget.udiagram),
    );
  }
